...
public function get_scan_progress(){
  ...
  public function process_scan_submit(){
    ...
    if (isset($_POST['rsssl_stop_scan']) ) {
        ...
        wp_clear_scheduled_hook('rsssl_pro_run_scan');
        return;
    }
 ...
 public function add_scan_page(){
   ...
   <form id="rsssl_scan_form" action="" method="POST">
     ...
     <ul class="rsssl-tips">
       ...
       <li><?php _e("You can close this window during the can, and come back later to finish it.", "really-simple-ssl-pro");?></li>
 ...
 */
  ...
  public function ignore($url) {
    ...
    public function ignore_array_search($value, $key) {
